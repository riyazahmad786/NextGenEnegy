...
var chart5 = new ApexCharts(document.querySelector("#appointment-chart1"), options2);
chart5.render();

var chart6 = new ApexCharts(document.querySelector("#appointment-chart2"), options2);
chart6.render();

var chart7 = new ApexCharts(document.querySelector("#appointment-chart3"), options2);
chart7.render();
